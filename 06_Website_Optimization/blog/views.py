...
def index(request):
    ...
    most_popular_posts = posts.order_by('-likes_count', 'title')
    ...
    most_fresh_posts = posts.order_by('-published_at', 'title')
    ...
    most_popular_tags = tags.order_by('-tags_count', 'title')[:5]
