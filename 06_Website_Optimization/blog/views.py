...
def index(request):
    posts = Post.objects.prefetch_tags_with_posts_count().prefetch_related('author')
...
def post_detail(request, slug):
    posts = Post.objects.popular().prefetch_tags_with_posts_count().prefetch_related('author')
